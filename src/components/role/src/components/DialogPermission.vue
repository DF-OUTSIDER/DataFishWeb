 ...
 * @FilePath: \undefinedd:\publicProject\vue-element-plus-admin\src\components\role\src\components\DialogPermission.vue
 * @Description: 
 * 
...
<template>
  <ContentWrap :title="t('permissionVo.title')" :message="t('common.message')">
    <PermissionWrite ref="writeRef" :current-row="currentRow" />
...
import { getRolePermissionDetailApi } from '@/system/role/api'
