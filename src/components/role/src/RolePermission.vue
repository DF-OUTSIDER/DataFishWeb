 ...
 * @FilePath: \vue-element-plus-admin\src\components\role\src\RolePermission.vue
 * @Description: 
 * 
...
<template>
  ...
  >
    ...
    <DialogPermission ref="dialogPermission" :roleId="roleId" :menu-id="menuId" />
    <template #footer>
...
import { DialogPermission } from '@/components/role/src/components'
