...
-->
<template>
  <DictItemWrite ref="writeRef" :current-row="currentRow" />
...
import DictItemWrite from './components/DictItemWrite.vue'

import { DictItemType } from '@/system/dict/api/types'
import { getDictItemDetailApi, saveDictItemApi } from '@/system/dict/api'
...
const writeRef = ref<ComponentRef<typeof DictItemWrite>>()
