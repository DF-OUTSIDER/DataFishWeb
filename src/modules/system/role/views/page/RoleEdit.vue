 ...
 * @FilePath: \vue-element-plus-admin\src\modules\system\role\views\page\RoleEdit.vue
 * @Description: 
 * 
...
<template>
  <ContentDetailWrap :title="t('common.edit')" @back="push('/system/role')">
    <RoleWrite ref="writeRef" :current-row="currentRow" :schema="allSchemas.formSchema" />
...
import { saveRoleApi, getRoleDetailApi } from '@/modules/system/role/api'
...
const getRoleDetail = async () => {
  const res = await getRoleDetailApi(query.id as unknown as number)
  if (res) {
