 ...
 * @FilePath: \vue-element-plus-admin\src\api\dict\index.ts
 * @Description:
 *
 * Copyright (c) 2023 by outsider 515885633@qq.com, All Rights Reserved.
 */
import request from '@/config/axios'
import { DictType, DictItemType } from './types'
...
export const getDictItemListApi = (params: any): Promise<IResponse> => {
