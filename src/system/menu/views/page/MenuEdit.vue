 ...
 * @FilePath: \undefinedd:\publicProject\vue-element-plus-admin\src\views\menu\page\MenuEdit.vue
 * @Description: 
 * 
...
import { getMenuDetailApi, saveMenuApi } from '@/system/menu/api'
...
const getMenuDetail = async () => {
  const res = await getMenuDetailApi(query.id as number)
  if (res) {
...
<template>
  <ContentDetailWrap :title="t('common.edit')" @back="push('/system/menu')">
    <MenuWrite ref="writeRef" :current-row="currentRow" />
