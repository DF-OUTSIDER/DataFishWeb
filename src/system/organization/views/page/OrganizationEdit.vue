 ...
 * @FilePath: \vue-element-plus-admin\src\system\organization\views\page\OrganizationEdit.vue
 * @Description: 
 * 
...
import OrganizationWrite from './components/OrganizationWrite.vue'
import { getOrganizationDetailApi, saveOrganizationApi } from '@/system/organization/api'
...
const getOrganizationDetail = async () => {
  const res = await getOrganizationDetailApi(query.id as number)
  if (res) {
